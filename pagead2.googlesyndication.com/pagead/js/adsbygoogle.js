(function() {
    ...
    */
    ...
    function y(a, b, c, d) {
        ...
        a.o = {};
        if (c)
            for (b = 0; b < c.length; b++) e = c[b], e < a.g ? (e += a.f, a.b[e] = a.b[e] || Gb) : (Hb(a), a.c[e] = a.c[e] || Gb);
        if (d && d.length)
            for (b = 0; b < d.length; b++) Ib(a, d[b])
    }
    var Gb = [];
    ...
    function Qb(a) {
        if (a.a)
            for (var b in a.a) {
                var c = a.a[b];
                if ("array" == xa(c))
                    for (var d = 0; d < c.length; d++) c[d] && Qb(c[d]);
                else c && Qb(c)
            }
        return a.b
    }
    ...
    */
    ...
    var ge = !!window.google_async_iframe_id,
    ...
    function af(a, b, c, d, e, f) {
        if ((d ? a.a : Math.random()) < (e || .01)) try {
            ...
            else g = new Ue, F(c, function(k, m) {
                var n = g,
                    r = n.g++;
                k = Ve(m, k);
                n.a.push(r);
    ...
    var If = new Ff(["google-auto-placed"], {
        google_tag_origin: "qs"
    });
    var Jf = {},
        Kf = (Jf.google_ad_channel = !0, Jf.google_ad_host = !0, Jf);
        ...
        b.forEach(function(e) {
            if (B(e, xe, 1)) {
                ...
                if (B(e, N, 1) && B(B(e, N, 1), L, 1) && B(e, N, 2) && B(B(e, N, 2), L, 1)) {
                    var f = bh(a, B(B(e, N, 1), L, 1)),
                        g = bh(a, B(B(e, N, 2), L, 1));
                    if (f && g)
                        for (f = ea(Zg({
                                anchor: f,
    ...
    function nh(a, b) {
        ...
        if (f = !e && B(a.b, Me, 15) && Lb(B(a.b, Me, 15), 12)) a: {
            f = ag(a.a);f = null !== f ? C(f, Yf, 5) : null;
            var g = ag(a.a);
    ...
    function ph(a, b, c, d) {
        ...
        if (!(f = null == e)) {
            ...
            if (c = !f && !(!c && 2 == e && !hh(d))) c = 1 == e || 2 == e ? d : d.parentNode,
            c = !(c && !Eg(c) && 0 >= c.offsetWidth);f = !c
        }
        if (!(c = f)) {
            c = a.o;
            f = z(b, 2);
        ...
        b = Gf(a.j, c, null == b ? null : new Ff(null, {
            google_ml_rank: b
        }));
        c = a.a;
        a = a.u;
        ...
        a: {
            try {
                ...
                b: {
                    var v = f.W;v.setAttribute("data-adsbygoogle-status", "reserved");v.className += " adsbygoogle-noablate";n = {
                        element: v
                    };
                    var M = b && b.ya;
    ...
    function bi(a) {
        ...
        var c = me(p, Rh.s),
            d = Ah(p.location, "google_ads_preview");
        return b && !a && c || d
    }
    ...
    function Wi(a, b, c) {
        if (lc(a.document.getElementById(b).contentWindow)) a = a.document.getElementById(b).contentWindow, b = a.document, b.body && b.body.firstChild || (/Firefox/.test(navigator.userAgent) ? b.open("text/html", "replace") : b.open(), a.google_async_iframe_close = !0, b.write(c));
        else {
    ...
    */
    ...
    function sj(a, b, c, d, e) {
        ...
        if ("in-article" == f && "false" != e.google_full_width_responsive) {
            var g = og(b, c, a, .2, e);
            if (!0 !== g) e.gfwrnwer = g;
            else if (g = P(b)) e.google_full_width_responsive_allowed = !0, c.parentElement && (tg(b, c), vg(b, c), a = g)
        }
        ...
        r = Bf(248,
            function() {
                ...
                a: if (f) {
                    ...
                    D = a / 1.2;
                    if (qg(c)) v = D;
                    else if (v = Math.min(D, Cj(c, d, e)), v < .5 * D || 100 > v) v = D;
        ...
        if ("autorelaxed" == c) {
            a: {
                if ("pedestal" != b.google_content_recommendation_ui_type)
                    for (a = ea(jj), c = a.next(); !c.done; c = a.next())
                        if (null != b[c.value]) {
                            b = !0;
                            break a
                        }
    ...
    function xk(a, b, c, d) {
        ...
        if (b.google_enable_single_iframe) {
            ...
            'google_async_iframe_id="' + d + '";', "</" + ok + ">", "<" + ok + ">window.parent.google_sa_impl({iframeWin: window, pubWin: window.parent, vars: window.parent['google_sv_map']['" + (d + "']});</") + ok + ">", "</body></html>"
    ...
    function Wk(a, b) {
        ...
        if (c) Yk(a, b);
        else if ((c = a.params) && be(c, function(e, f) {
                b[f] = e
    ...
    function Yk(a, b) {
        if (K(E).skip_next_reactive_tag) K(E).skip_next_reactive_tag = !1;
            ...
            a: if (!K(E).ama_ran_on_page) {
                ...
                if (b = d)
                    if (c = B(b, Ge, 3), !c || z(c, 1) <= Date.now()) try {
    ...
    function bl() {
        ...
        if (b.plle) Si(si(a), 1);
            ...
            S(b, g);
            Kh(a, 12) && (d = Sh, c = Rh, g = Vi(a, new ni(0), Oc(e.a[149]), Oc(e.a[150]), [d.i, d.s], 4), S(b, g), g == d.i ? f = c.i : g == d.s ? f = c.s : f = "", S(b, f));
            d = Uh;
        ...
        if (!t("Trident") && !t("MSIE") || 0 <= hb(tb(), 11)) {
            ...
            if (!h || !h.loaded) {
                ...
                if (h)
                    for (f = ea(["requestNonPersonalizedAds", "pauseAdRequests",
                            "cookieOptions"
                        ]), b = f.next(); !b.done; b = f.next()) b = b.value, void 0 !== h[b] && (a[b] = h[b]);
