(function() {
    ...
    */
    ...
    function ra(a, b) {
        var c = A(a);
        if (!sa.test(c)) throw Error("Invalid TrustedResourceUrl format: " + c);
    ...
    function Oa(a, b) {
        if (0 == a.f)
            if (a.i) {
                var c = a.i;
                if (c.h) {
                    for (var d = 0, e = null, f = null, g = c.h; g && (g.g || (d++, g.a == a && (e = g), !(e && 1 < d))); g = g.next) e || (f = g);
                    e && (0 == c.f && 1 == d ? Oa(c, b) : (f ? (d = f, d.next == c.j && (c.j = d), d.next = d.next.next) : Pa(c), Qa(c, e, 3, b)))
                }
                a.i = null
            } else N(a, 3, b)
    }
    ...
    function N(a, b, c) {
        0 == a.f && (a === c && (b = 3, c = new TypeError("Promise cannot resolve to itself")), a.f = 1, Ma(c, a.H, a.I, a) || (a.D = c, a.f = b, a.i = null, Sa(a), 3 != b || c instanceof O || Ta(a, c)))
    }

    function Ma(a, b, c, d) {
        if (a instanceof M) return Ra(a, Ja(b || r, c || null, d)), !0;
        if (a) try {
    ...
    M.prototype.G = function() {
        for (var a; a = Pa(this);) Qa(this, a, this.f, this.D);
        this.u = !1
    };
    ...
    S.prototype.snapshotSync = function() {
        if (this.b) return this.b.snapshotSync()
    };
    ...
    function V(a, b) {
        var c = new qb;
        U(c, "t", a);
        b && (U(c, "li", b.C), U(c, "cr" === b.context ? "bgai" : "jk", b.B));
        return c
    }
    ...
    Y.prototype.g = function() {
        var a = this;
        if ("env" === this.a.w) return mb(this).then(function(c) {
            a.l = c;
            a.l && rb(a.l, a.a)
        });
        var b = window;
        b.GoogleA13IjpGc || (lb(this), b.GoogleA13IjpGc = this);
        return Ka()
    };
    ...
    Z.prototype.g = function() {
        ...
        return mb(this).then(function(b) {
            a.l = b;
            if (a.l) return rb(a.l, a.a)
        })
    };

    function sb(a, b) {
        if ("number" === typeof a) b = X(a, b);
        else {
            var c = V(3, b);
            U(c, "c", "init");
            var d = a.toString();
            ...
            if (a.stack) {
                ...
                try {
                    -1 == a.indexOf(d) && (a = d + "\n" + a);
                    for (var e; a != e;) e = a, a = a.replace(/((https?:\/..*\/)[^\/:]*:\d+(?:.|\n)*)\2/, "$1");
                    d = a.replace(/\n */g, "\n")
                } catch (f) {}
            }
            U(c, "ex", d);
    ...
    function tb(a) {
        ...
        if (!window.postMessage && T(a)) throw 8;
        return a.g()
    };
    (function() {
        var a = cb();
